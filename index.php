   ...
   <div class="col-lg-5 mr-auto order-lg-1" data-aos="fade-up" data-aos-delay="100">
    ...
    <div class="accordion-item">
     <h3 class="mb-0 heading">
      <a
       class="btn-block <?php echo ($first ? 'collapsed' : ''); ?>"
       data-toggle="collapse"
       href="#collapse-<?php echo get_row_index(); ?>"
       role="button"
 ...
 <div class="container">
  <div class="row justify-content-center" data-aos="fade-up">
   <div class="col-lg-6 text-center heading-section mb-5">
    ...
    <h2 class="text-black mb-2"><?php the_field('services_title'); ?></h2>
    <p><?php the_field('services_description'); ?></p>
   </div>
  </div>
  <div class="row">
   <?php if (have_rows('services_entries')) : ?>
   <?php while (have_rows('services_entries')) : the_row(); ?>
   <div class="col-md-6 mb-4 col-lg-4" data-aos="fade-up" data-aos-delay="">
    <div class="block_service">
     <?php $image = get_sub_field('service_image'); ?>
     <?php if ($image) : ?>
     <img src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" class="img-fluid mb-5" />
     <?php endif; ?>
